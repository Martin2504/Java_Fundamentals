...
/*  Demonstrates how to create a scrollable and updatable
result set. The program creates a result set for the StateCapital table */
...
public class ScrollUpdateResultSet {
    public static void main(String[] args)
        ...
        Statement statement = connection.createStatement(               // creates a Statement for producing scrollable and updatable result sets
        ...
        resultSet.absolute(2); // Move cursor to the second row in the result set
