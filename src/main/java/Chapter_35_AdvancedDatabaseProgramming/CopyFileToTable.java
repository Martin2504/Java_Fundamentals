...
/* You can send a batch of SQL statements to the database for execution at once to
improve efficiency.
This program gets data from a text file and copies the data from the text file to a table.
*/
...
public class CopyFileToTable extends Application {
    ...
    public void start(Stage primaryStage) {                                     // Creating the SQL Client
    ...
    private void insertRows(Connection connection) {            // uses the batch updates to submit SQL INSERT commands to the database for execution
        // Build the SQL INSERT statement
        String sqlInsert = "insert into " + tfTableName.getText() + " values (";
