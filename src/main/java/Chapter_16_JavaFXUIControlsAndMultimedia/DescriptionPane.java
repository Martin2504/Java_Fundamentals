...
// Class sets the foundations for TextAreaDemo
...
public class DescriptionPane extends BorderPane {
    ...
    public DescriptionPane() {
        // Center the icon and the text and place the text unde the icon
        lblImageTitle.setContentDisplay(ContentDisplay.TOP);            // label properties
