...
// Demonstrates the use of IntStreams

/*
IntStream, LongStream, and DoubleStream are special type of streams for
processing a sequence of primitive int, long, and double values.
 */
...
public class IntStreamDemo {
    public static void main(String[] args) {
        ...
        System.out.println("The sum of the first four numbers is: "
