...
// Demonstrates using a generic method to sort an array of comparable objects
...
public class GenericSort {
     ...
     */
    public static <E extends Comparable<E>> void sort(E[] list) {       // E is a subtype of comparable. Elements to be compared are of type E
        E currentMin;
        int currentMinIndex;
